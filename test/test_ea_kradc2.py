...
class KnownValues(unittest.TestCase):
    ...
    def test_ea_kradc2_a(self):
        ...
        e1, v1, convs1 = run(mf, nroots=3, which='ea', do_mp2=False)
        e2, v2, convs2 = run(smf, nroots=6, which='ea', do_mp2=False)
        ...
        #self.assertAlmostEqual(e1[5], e2[5], 7) #FIXME: this fails badly, what gives?

    def test_ea_kradc2_b(self):
